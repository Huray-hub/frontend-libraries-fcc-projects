...
const LengthControl = (props) => {
  ...
  const StartStopButton = (props) => {
    ...
    return (
      <button className="btn" id="start_stop" onClick={handlePlayButton}>
  ...
  const ResetButton = (props) => {
    ...
    return (
      <button className="btn" id="reset" onClick={handleResetButton}>
    ...
    return (
      <div className="app-container">
        ...
        <div className="timer-control">
          <StartStopButton isPlaying={isPlaying} setIsPlaying={setIsPlaying} />
          <ResetButton
